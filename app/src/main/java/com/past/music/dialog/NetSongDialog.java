 ...
 * =======================================================
 */
public class NetSongDialog extends AlertDialog {
    ...
    public NetSongDialog(Context context) {
        super(context, R.style.style_dialog);
        this.mContext = context;
    }

    public NetSongDialog(Context context, MusicEntity musicEntity, int type) {
        super(context, R.style.style_dialog);
        this.mContext = context;
    ...
    private void setMusicInfo() {
        ...
        setInfo("下载", R.drawable.lay_icn_share);
