...
public class DownService extends Service {
    public static final String ADD_DOWNTASK = "com.past.music.downtaskadd";
    public static final String ADD_MULTI_DOWNTASK = "com.past.music.multidowntaskadd";
    public static final String CANCLE_DOWNTASK = "com.past.music.cacletask";
    public static final String CANCLE_ALL_DOWNTASK = "com.past.music.caclealltask";
    public static final String START_ALL_DOWNTASK = "com.past.music.startalltask";
    public static final String RESUME_START_DOWNTASK = "com.past.music.resumestarttask";
    public static final String PAUSE_TASK = "com.past.music.pausetask";
    public static final String PAUSE_ALLTASK = "com.past.music.pausealltask";

    public static final String UPDATE_DOWNSTAUS = "com.past.music.updatedown";
    public static final String TASK_STARTDOWN = "com.past.music.taskstart";
    public static final String TASKS_CHANGED = "com.past.music.taskchanges";
    ...
    private String getDownSave() {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/pastmusic/");
            if (!file.exists()) {
    ...
    private Notification getNotification(boolean complete) {
        ...
        nowPlayingIntent.setComponent(new ComponentName("com.past.music", "com.past.music.activity.DownloadActivity"));
        PendingIntent clickIntent = PendingIntent.getActivity(this, 0, nowPlayingIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        remoteViews.setImageViewResource(R.id.image, R.drawable.placeholder_disk_210);
        if (complete) {
            remoteViews.setTextViewText(R.id.title, "pastmusic");
