...
import com.past.music.api.SearchAlbumInfo;
import com.past.music.api.SearchArtistInfo;
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    for (JsonElement o : songArray) {
                        SearchSongInfo songInfo = MyApplication.gsonInstance().fromJson(o, SearchSongInfo.class);
