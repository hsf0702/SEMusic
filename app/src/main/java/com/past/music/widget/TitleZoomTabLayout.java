...
import com.past.music.utils.AnimationUtils;
...
/**
 * Created by gaojin on 2017/12/26.
 */
...
public class TitleZoomTabLayout extends FrameLayout {
    ...
    public TitleZoomTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
            ...
            if (mMode == MODE_FIXED && mTabGravity == GRAVITY_CENTER) {
                ...
                for (int i = 0, z = count; i < z; i++) {
                    ...
                    int strWidth = (int) (paint.measureText(((TabView) child).mTextView.getText().toString()) + lp.leftMargin + lp.rightMargin + mTabPaddingStart + mTabPaddingEnd);
