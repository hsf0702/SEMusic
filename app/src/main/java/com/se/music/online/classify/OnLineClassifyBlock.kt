...
class OnLineClassifyBlock : LinearLayout, View.OnClickListener {
    ...
    private lateinit var singer: View
    private lateinit var rank: View
    private lateinit var radio: View
    private lateinit var list: View
    private lateinit var mv: View
    private lateinit var album: View
